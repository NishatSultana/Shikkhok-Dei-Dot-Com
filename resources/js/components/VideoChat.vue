<template>
  <div class="container">
    <h1 class="text-center">Shikkhok Dei Dot Com Video Chat</h1>
    <div class="video-container" ref="video-container">
      ...
      <div class="text-right" v-for="(full_name,userId) in others" :key="userId">
        <button @click="startVideoChat(userId)" v-text="`Talk with ${full_name}`"/>
      </div>
    </div>
  </div>
</template>
